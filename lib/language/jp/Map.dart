...
import 'package:Nanglea/classes/Trave_jp.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/services.dart';
import 'package:Nanglea/core/presentation/res/assets_jp.dart'; //
import 'package:Nanglea/language/jp/Item.dart'; //

import 'package:Nanglea/language/jp/coffee_model.dart'; //
import 'package:Nanglea/widgets/network_image.dart'; //th
                                    ...
                                    children: [
                                      ...
                                      Flexible(
                                        ...
                                        child: Container(
                                          width: 170.0,
                                          child:
                                          Text(coffeeShops[index].description,
                                              style: TextStyle(
                                                fontSize: 11.0,
                                                fontFamily: "Kanit",
                                                color: Colors.grey[600],
